                    ...
                    child: Column(
                      ...
                      Container(
                          ...
                          child: Stack(alignment: Alignment.topLeft, children: [
                            ...
                            CustomImageView(
                                ...
                                margin: getMargin(left: 20, top: 52),
                                onTap: () {
                                  onTapImgArrowleft();
                                }),
                            Align(
                            ...
                            Align(
                                ...
                                child: Padding(
                                    ...
                                    child: Text("msg_breathing_exercises2".tr,
                            ...
                            Align(
                                ...
                                child: Padding(
                                    padding: getPadding(left: 15, bottom: 108),
                                    child: Text("msg_check_your_schedule".tr,
                                        overflow: TextOverflow.ellipsis,
                                        textAlign: TextAlign.left,
                            ...
                            CustomImageView(
                                imagePath:
                                    ImageConstant.img5184247removebgpreview,
                                height: getVerticalSize(163),
                                width: getHorizontalSize(166),
                                alignment: Alignment.topRight,
                                margin: getMargin(top: 90, right: 7)),
                            Align(
                                alignment: Alignment.bottomCenter,
                                child: Container(
                                    width: double.maxFinite,
                      ...
                      Padding(
                          ...
                          child: Text("lbl_edit_schedule".tr,
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.left,
                              style: AppStyle.txtInterMedium12Lightgreen600)),
                      Padding(
                          ...
                          child: Text("msg_choose_your_program".tr,
                              ...
                              style: AppStyle.txtInterRegular20)),
                      Padding(
                          padding: getPadding(left: 16, top: 24, right: 30),
                          child: Row(children: [
                            GestureDetector(
                                onTap: () {
                                ...
                                child: Stack(
                                    ...
                                    children: [
                                      ...
                                      CustomButton(
                                          height: getVerticalSize(69),
                                          width: getHorizontalSize(152),
                                          text: "msg_reduce_stress_level".tr,
                                          variant: ButtonVariant
                                              .OutlineLightgreen600,
                                          padding: ButtonPadding.PaddingT27,
                                          alignment: Alignment.center)
                                    ]))
                          ])),
                      Container(
