...
class CustomRadioButton extends StatelessWidget {
  ...
  _setFontStyle() {
    switch (fontStyle) {
      case RadioFontStyle.InterSemiBold12:
        return TextStyle(
      ...
      case RadioFontStyle.PlayfairDisplaySemiBold12:
        return TextStyle(
          color: ColorConstant.whiteA700,
          fontSize: getFontSize(
            12,
      ...
      case RadioFontStyle.PlayfairDisplayMedium12:
        return TextStyle(
          color: ColorConstant.whiteA700,
          fontSize: getFontSize(
            12,
...
enum RadioFontStyle {
  ...
  InterSemiBold12,
  InterMedium12,
  PlayfairDisplaySemiBold12,
  PlayfairDisplayMedium12,
}
